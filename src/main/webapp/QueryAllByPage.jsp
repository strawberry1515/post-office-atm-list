...
<c:if test="${atms!=null&&atms.size()!=0}">
				...
				<c:forEach items="${atms}" var="atm" varStatus="s">
					...
					<div class="data">
						<a href="DeleteById?id=${atm.key}"><input type="button"
							id="delBtn${s.count}" value="刪除" disabled></a><input
							type="checkbox" id="confirm${s.count}" name="confirm"
			...
			<div class="footer box">
				<c:forEach var="page" begin="1" end="${atm.key}" step="20"
					varStatus="s">
					<a href="QueryAllByPage?page=${page}"><span class="pageSwitch" id="page${page}" style="cursor: pointer;">${page}-</span></a>
				</c:forEach>
